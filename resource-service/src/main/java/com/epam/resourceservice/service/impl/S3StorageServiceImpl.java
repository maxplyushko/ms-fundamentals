...
public class S3StorageServiceImpl implements S3StorageService {
  ...
  private static final String S3_FILE_LOCATION_URL = "%s/%s/%s";
  ...
  public SongResource upload(MultipartFile file) {
    ...
    String fileUrl = String.format(S3_FILE_LOCATION_URL, awsS3Config.getAwsS3EndpointUrl(),
    ...
    return buildSongResource(fileName, fileUrl, putObjectResult);
  }

  private SongResource buildSongResource(String fileName, String fileUrl,
      PutObjectResult putObjectResult) {
